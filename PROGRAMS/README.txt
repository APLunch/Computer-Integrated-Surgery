...
assignment345_utilities.py: 
	Utility functions specified to programming assignment 3, 4 and 5. Including functions that read and compare data from files, mesh loading, and other tasks.
registration.py: 
...
main_PA5.py:
	The main file that calls functions to complete tasks of programming assignment 5.
plotter.py:
...
Using IDE:
		Open main_PA5.py in an IDE and run the script
