...
assignment3_utilities.py: 
	Utility functions specified to programming assignment 1. Including functions that read and compare data from files, and mesh loading.
registration.py: 
...
Using IDE:
		Open main_PA3.py in an IDE and run the script
